...
public class MethodUser {
  ...
  public void login(User user) {
    ...
    while (!loginBerhasil) {
      ...
      for (int i = 0; i < x; i++) {
        if (
          email.equals(user.getEmail(i)) && password.equals(user.getPassword(i))
        ) {
  ...
  public void cariLayananPublik(
    LayananPublik layanan,
    LokasiLayananPublik lokasi
  ) {
    System.out.println();
    ...
    do {
      ...
      for (int i = 0; i < layanan.getJmlLayanan(); i++) {
        ...
        if (
          namaLayanan.toLowerCase().contains(kataKunci.toLowerCase()) ||
      ...
      if (!ditemukan) {
        System.out.println(
          "Layanan Publik dengan kata kunci '" +
          kataKunci +
          "' tidak ditemukan."
        );
  ...
  public void cariLokasiLayananPublik(
    User user,
    LayananPublik layanan,
    LokasiLayananPublik lokasi
  ) {
    ...
    do {
      ...
      for (int i = 0; i < lokasi.getJmlLokasi(); i++) {
        ...
        if (lokasi.getIdLayananPublik(i) == getIdLayananPublikTerpilih()) {
          ...
          if (alamat.toLowerCase().contains(kataKunci.trim().toLowerCase())) {
            System.out.println(
              "ID Lokasi Layanan Publik: " + lokasi.getIdLokasi(i)
            );
            System.out.println(
              "Nama Tempat Layanan: " + lokasi.getNamaTempat(i)
            );
      ...
      if (!ditemukan) {
        System.out.println(
          "Lokasi Layanan Publik dengan kata kunci '" +
          kataKunci +
          "' tidak ditemukan."
        );
    ...
    if (ditemukan) {
      ...
      String namaLayananTerpilih = layanan.getNamaLayanan(
        idLayananPublikTerpilih
      );
  ...
  public void mengajukanPermohonanLayananPublik(
    User user,
    LayananPublik layanan,
    LokasiLayananPublik lokasi,
    PermohonanLayananPublik permohonan,
    DatabasePermohonan databasePermohonan
  ) {
    Scanner scanner = new Scanner(System.in);
    ...
    permohonan.setnamaLayananTerpilih(
      layanan.getNamaLayanan(idLayananPublikTerpilih)
    );
    permohonan.setnamaTempatLayananTerpilih(
      lokasi.getNamaTempat(idLokasiTerpilih)
    );
    permohonan.setIdPermohonan(
      databasePermohonan.getPermohonanList().size() + 1
    );
    ...
    System.out.printf(
      ...
      "File Dokumen"
    ); // Dokumen dukungan default saat mengajukan permohonan
    System.out.println(
      "========================================================================================"
    );
  ...
  public void ubahStatusPermohonan(
    DatabasePermohonan databasePermohonan,
    User user
  ) {
    Scanner scanner = new Scanner(System.in);
    ...
    System.out.print(
      "Masukkan ID Permohonan yang ingin diubah statusnya menjadi 'Selesai': "
    );
    ...
    for (PermohonanLayananPublik permohonan : bookedData) {
      if (
        permohonan.getIdPermohonan() == idPermohonanToUpdate &&
    ...
    if (validId) {
      ...
      for (PermohonanLayananPublik permohonan : bookedData) {
        if (permohonan.getIdPermohonan() == idPermohonanToUpdate) {
          ...
          System.out.println(
            "Status Permohonan berhasil diubah menjadi 'Selesai'."
          );
          break;
        }
      }
  ...
  public int getIdLokasiTerpilih() {
    ...
    return idLokasiDitemukan.isEmpty()
      ? -1
      : idLokasiDitemukan.get(idLokasiDitemukan.size() - 1);
  }
  ...
  public void setIdLokasiTerpilih(int idLokasiTerpilih) {
    ...
    System.out.println(
      "ID Lokasi Layanan Publik yang dipilih: " + idLokasiTerpilih
    );
  }
