...
public class TampilData {
     ...
     public void tampil(LayananPublik layananPublik) {
        ...
        System.out.println();
        System.out.println("===================================   TABEL LAYANAN PUBLIK  =====================================");
        
         System.out.printf("%-15s%-25s%-15s%-25s%-25s%n", "ID Layanan", "Nama Layanan", "Kategori", "Persyaratan", "Prosedur");
        System.out.println("----------------------------------------------------------------------------------------");

        // Data Tabel
        for (int i = 0; i < layananPublik.getJmlLayanan(); i++) {
            System.out.printf("%-15d%-25s%-15s%-25s%-25s%n",
        ...
        System.out.println();
        System.out.println("===================================   TABEL LOKASI LAYANAN PUBLIK  =====================================");
        
        System.out.printf("%-15s%-48s%-30s%-20s%-20s%n", "ID Lokasi", "Nama Tempat Layanan", "Alamat", "Jam Buka", "Kontak");
        System.out.println("----------------------------------------------------------------------------------------");
        ...
        for (int i = 0; i < lokasi.getJmlLokasi(); i++) {
            if (lokasi.getIdLayananPublik(i) == idLayananPublik) {
                System.out.printf("%-15s%-48s%-30s%-20s%-20s%n",
        ...
        if (!ditemukan) {
            System.out.println("Data Lokasi Layanan Publik tidak ditemukan untuk ID Layanan Publik: " + idLayananPublik);
        }
    }
    ...
    System.out.println("=================================== Informasi Permohonan =============================================================================");
    System.out.printf("%-25s%-25s%-48s%-20s%-25s%n", "Nama User Login", "Nama Layanan Terpilih", "Nama Tempat Layanan", "Status", "Dukungan Dokumen");
    System.out.println("-------------------------------------------------------------------------------------------------------------------------------------");
...
public void tampilKumpulanDataPermohonan(User user) {
    System.out.println("=================================== Data Permohonan Layanan Publik ===================================");
    System.out.printf("%-15s%-25s%-25s%-48s%-20s%-25s%n",  "ID", "Nama User Login", "Nama Layanan Terpilih", "Nama Tempat Layanan", "Status", "Dukungan Dokumen");
    System.out.println("-------------------------------------------------------------------------------------------------------------------------------------");

    List<PermohonanLayananPublik> bookedData = user.getBookedData();

    for (PermohonanLayananPublik permohonan : bookedData) {
        System.out.printf("%-15s%-25s%-25s%-48s%-20s%-25s%n",
